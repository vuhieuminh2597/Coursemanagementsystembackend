package com.example.coursems.model.customer;
...
public class CustomerPage {
    ...
    public CustomerPage(Integer page, Integer size, Object data) {
        this.page = page;
        this.size = size;
        this.data = data;
    }
    ...
    public void setNext(Integer page, Integer size, Long totalElement,Integer totalPages) {
        if (page != null && size != null && totalElement > size && page + 2 <= totalPages) {
            StringBuilder builder = new StringBuilder("http://localhost:8080/api/v1/customer");
